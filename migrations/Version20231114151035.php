 ...
 */
final class Version20231114151035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant CHANGE password mot_passe VARCHAR(30) NOT NULL');
        ...
        $this->addSql('ALTER TABLE ville CHANGE code_postal code_postal VARCHAR(10) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participant CHANGE mot_passe password VARCHAR(30) NOT NULL');
